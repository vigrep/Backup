...
" lookup file with ignore case ºöÂÔ´óĞ¡Ğ¡²éÑ¯ÎÄ¼ş
...
function! CppSetting()
	set autoindent 		" ¼Ì³ĞÇ°Ò»ĞĞµÄËõ½ø·½Ê½£¬ÌØ±ğÊÊÓÃÓÚ¶àĞĞ×¢ÊÍ
	set smartindent 	" ÎªC³ÌĞòÌá¹©×Ô¶¯Ëõ½ø
	set cindent 		" Ê¹ÓÃCÑùÊ½µÄËõ½ø
	set tabstop=4
	set shiftwidth=4 	" Ëõ½ø¿í¶ÈÎª4
	"set softtabstop=4 	" ÉèÖÃÈíÖÆ±í·û
	set nu
	set nowrap
...
" SHOWMARK
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"ShowMarks²å¼şÖĞÒÑ¾­¶¨ÒåÁËÒ»Ğ©¿ì½İ¼ü£º
...
" Ê¹ÓÃpumvisible()À´ÅĞ¶ÏÏÂÀ­²Ëµ¥ÊÇ·ñÏÔÊ¾
inoremap <expr> <CR> pumvisible()?"\<C-Y>":"\<CR>"
"Èç¹ûÏÂÀ­²Ëµ¥µ¯³ö£¬»Ø³µÓ³ÉäÎª½ÓÊÜµ±Ç°ËùÑ¡ÏîÄ¿£¬·ñÔò£¬ÈÔÓ³ÉäÎª»Ø³µ
inoremap <expr> <C-J> pumvisible()?"\<PageDown>\<C-N>\<C-P>":"\<C-X><C-O>"
"Èç¹ûÏÂÀ­²Ëµ¥µ¯³ö£¬CTRL-JÓ³ÉäÎªÔÚÏÂÀ­²Ëµ¥ÖĞÏòÏÂ·­Ò³¡£·ñÔòÓ³ÉäÎªCTRL-X CTRL-O
"inoremap <expr> <C-K> pumvisible()?"\<PageUp>\<C-P>\<C-N>":"\<C-K>"
"Èç¹ûÏÂÀ­²Ëµ¥µ¯³ö£¬CTRL-KÓ³ÉäÎªÔÚÏÂÀ­²Ëµ¥ÖĞÏòÉÏ·­Ò³£¬·ñÔòÈÔÓ³ÉäÎªCTRL-K
"inoremap <expr> <C-U> pumvisible()?"\<C-E>":"\<C-U>"
"Èç¹ûÏÂÀ­²Ëµ¥µ¯³ö£¬CTRL-UÓ³ÉäÎªCTRL-E£¬¼´Í£Ö¹²¹È«£¬·ñÔò£¬ÈÔÓ³ÉäÎªCTRL-U

""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" ×Ô¶¯²¹È« OMNI
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"ÕûĞĞ²¹È«			CTRL-X CTRL-L
"¸ù¾İµ±Ç°ÎÄ¼şÀï¹Ø¼ü×Ö²¹È«	CTRL-X CTRL-N
"¸ù¾İ×Öµä²¹È«			CTRL-X CTRL-K
"¸ù¾İÍ¬Òå´Ê×Öµä²¹È«		CTRL-X CTRL-T
"¸ù¾İÍ·ÎÄ¼şÄÚ¹Ø¼ü×Ö²¹È«		CTRL-X CTRL-I
"¸ù¾İ±êÇ©²¹È«			CTRL-X CTRL-]
"²¹È«ÎÄ¼şÃû			CTRL-X CTRL-F
"²¹È«ºê¶¨Òå			CTRL-X CTRL-D
"²¹È«vimÃüÁî			CTRL-X CTRL-V
"ÓÃ»§×Ô¶¨Òå²¹È«·½Ê½		CTRL-X CTRL-U
"Æ´Ğ´½¨Òé			CTRL-X CTRL-S
...
if MySys() == 'linux'
	...
	nmap <C-c>h :echo " s: ²éÕÒCÓïÑÔ·ûºÅ£¬¼´²éÕÒº¯ÊıÃû¡¢ºê¡¢Ã¶¾ÙÖµµÈ³öÏÖµÄµØ·½\n g: ²éÕÒº¯Êı¡¢ºê¡¢Ã¶¾ÙµÈ¶¨ÒåµÄÎ»ÖÃ£¬ÀàËÆctagsËùÌá¹©µÄ¹¦ÄÜ\n d: ²éÕÒ±¾º¯Êıµ÷ÓÃµÄº¯Êı\n c: ²éÕÒµ÷ÓÃ±¾º¯ÊıµÄº¯Êı\n t: ²éÕÒÖ¸¶¨µÄ×Ö·û´®\n e: ²éÕÒegrepÄ£Ê½£¬Ïàµ±ÓÚegrep¹¦ÄÜ£¬µ«²éÕÒËÙ¶È¿ì¶àÁË\n f: ²éÕÒ²¢´ò¿ªÎÄ¼ş£¬ÀàËÆvimµÄfind¹¦ÄÜ\n i: ²éÕÒ°üº¬±¾ÎÄ¼şµÄÎÄ¼ş"<cr>

endif
" s: ²éÕÒCÓïÑÔ·ûºÅ£¬¼´²éÕÒº¯ÊıÃû¡¢ºê¡¢Ã¶¾ÙÖµµÈ³öÏÖµÄµØ·½
" g: ²éÕÒº¯Êı¡¢ºê¡¢Ã¶¾ÙµÈ¶¨ÒåµÄÎ»ÖÃ£¬ÀàËÆctagsËùÌá¹©µÄ¹¦ÄÜ
" d: ²éÕÒ±¾º¯Êıµ÷ÓÃµÄº¯Êı
" c: ²éÕÒµ÷ÓÃ±¾º¯ÊıµÄº¯Êı
" t: ²éÕÒÖ¸¶¨µÄ×Ö·û´®
...
" let g:LookupFile_ableDefaultMap = 0 			"¹Ø±ÕÄ¬ÈÏÓ³Éä
...
"µ±Ç°ÃæÓĞÒ»¸ö·´Ğ±¸ÜÊ±£¬ÕâĞ©×Ö·û¾ßÓĞÌØÊâµÄº¬Òå¡£ÔÚËÑË÷ÖĞ³£ÓÃ
set magic
...
function! CurDir()
   let curdir = substitute(getcwd(), 'c:/Documents and Settings/ÄÏÑôÒ°ÈË/', "~/", "g")
   return curdir
endfunction
...
if has("gui_running") " Ó³ÉäËùÓĞAlt+XX¼ü¡££¨Ö»ÓĞGui½çÃæ²ÅÄÜÓ³Éä£©
	imap <m-h> <left>
	imap <m-l> <right>
	imap <m-j> <down>
	imap <m-k> <up>
...
"""""""""""""""""""""""""""""""""""""""""""""""""}}}
""" ENDING		{{{
"¹Ø±Õ×Ô¶¯ÅÅ°æ£¬Ê¡µÃÀÏÊÇÔÚÒ»ĞĞµÄ×¢ÊÍÖ®ºóÓÖÒªÔÙÉÏÈ¥×Ô¶¯Ìí¼ÓµÄ×¢ÊÍ×Ö·û
...
"È·±£ Vim ÄÜÔÚÖĞÎÄ×Ö·ûÖ®¼äÕÛĞĞ¶ø²»ÒªÇó¿Õ¸ñµÄ´æÔÚ£¬²¢ÇÒÔÚ´ó²¿·ÖÇé¿öÏÂ¿ÉÒÔÕıÈ·µØ´¦ÀíÖĞÎÄÖØĞÂ¸ñÊ½»¯¡£
...
"ÔÚ±à¼­×´Ì¬ÏÂ£¬°´ctrl+u£¬½«Äã¸Õ¸ÕÊäÈëµÄÄÇ¸öµ¥´Ê±ä³É´óĞ´
...
"ÎªÁË²»ºÍÆäËû¿ì½İ¼ü²úÉú³åÍ»£¬¿ÉÁÙÊ±Éè¶¨ Ö´ĞĞºê ¿ì½İ¼ü :nmap <F4> @s
nmap <F3> @a
imap <F3> <esc>@a
